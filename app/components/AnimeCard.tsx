    ...
    <div className="relative border border-stone-400 rounded-lg p-4 shadow-md flex flex-col items-center bg-blue-900 text-white w-full sm:w-64">
      ...
      <div className="w-full h-80 sm:h-80 flex justify-center items-center overflow-hidden">
        <img
          ...
          alt={Nombre}
          onError={(e) => {
            (e.target as HTMLImageElement).src = "../animeDefault.png"; // Cambiar a imagen por defecto si falla
          }}
      ...
      <NumberFlow className="text-lg sm:text-xl text-gray-300 text-center mt-2" value={Episodio} trend={0} format={{ notation: "compact" }} />
